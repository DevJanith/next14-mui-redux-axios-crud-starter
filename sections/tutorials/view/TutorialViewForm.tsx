...
// lib
import { fetchTutorial } from '@/lib/features/tutorials/tutorialsSlice';
      ...
      <Grid item md={12}>
        <FormikProvider value={formik}>
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            <Card>
              <DialogTitle>View Tutorial</DialogTitle>
              <Divider />
...
export default TutorialViewForm